        ...
        switch (encoding) {
            ...
            case 'windows-1251':
                ...
                const charsetAsUnicode = [
                    ...
                    0x0452, 0x2018, 0x2019,	0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x0000, 0x2122, 0x0459, 0x0203, 0x045A, 0x045C, 0x045B, 0x045F,
                ...
                this.write(value.length, () => {
                    for (let i = 0; i < value.length; i++) {
                        this.dataView.setUint8(this.pos + i, charsetAsUnicode.indexOf(value.charCodeAt(i)));
                    }
                });
                return;
            default:
